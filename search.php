			...
			<div class="card-deck flex-row no-wrap">
				...
				<div class="card">
					<span class="box">
						...
						<div class = "card-body">
							<div class="row">
								<button type="submit" class="btn btn-warning mx-auto" id = "addtohistory_hobbit">Add to Book History</button>
								<script>
								$(document).ready(function(){
								document.getElementById("addtohistory_hobbit").click = function(){
									addtohistory_hobbit();
									//document.getElementById("hobbithist").innerhtml= "Added to your list";
									//document.getElementById("addtohistory_hobbit").hide();
								}
								addtohistory_hobbit(){
									<?php
									$query = "insert into bookhistory (cust_id, book_id) values (".$_SESSION['id'].", 27);";
								...
								<button type="submit" class="btn btn-warning mx-auto" id = "addtolist_hobbit" style="margin:20px 0 50px 0; width: 140px;">Add to Book List</button>
								<script>
								$(document).ready(function(){
								document.getElementById("addtolist_hobbit").click = function(){
									addtolist_hobbit();
									//document.getElementById("hobbithist").innerhtml= "Added to your list";
									//document.getElementById("addtohistory_hobbit").hide();
								}
								addtolist_hobbit(){
									<?php
									$query = "insert into booklist (cust_id, book_id) values (".$_SESSION['id'].", 27);";
									if ($db->query($query) === TRUE) {
										echo "New record created successfully";
									} else {
										echo "Error: ";
